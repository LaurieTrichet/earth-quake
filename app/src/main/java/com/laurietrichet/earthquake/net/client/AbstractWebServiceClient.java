...
public abstract class AbstractWebServiceClient<T>{
     ...
     */
    public int get (String entryPoint, Bundle params, WebServiceClientListener listener){
     ...
     */
    abstract protected Request createRequest (String entryPoint, Bundle params, WebServiceClientListener listener);
