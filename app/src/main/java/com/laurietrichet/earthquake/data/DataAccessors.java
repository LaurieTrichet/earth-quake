...
public final class DataAccessors {
    ...
    public static enum DATA_ACCESSORS_ENUM { EARTH_QUAKE_DATA_ACCESSOR};
    ...
    public static IDataAccessor getAccessor (Context context, DATA_ACCESSORS_ENUM key){
        if (! mAccessorList.containsKey(key)){
            if (key == DATA_ACCESSORS_ENUM.EARTH_QUAKE_DATA_ACCESSOR){
                mAccessorList.put(DATA_ACCESSORS_ENUM.EARTH_QUAKE_DATA_ACCESSOR,
                        new EarthQuakeDataAccessor(context));
            }
        }
